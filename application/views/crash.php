  ...
  <div class="col-md-12 mt-4">
    <div class="card">
      ...
      <div class="card-body pt-4 p-3">
        <ul class="list-group">
          <?php
          $sql = mysqli_query($connEm, "SELECT * FROM pelanggaran WHERE nis = '$nis_santri' ");
          while ($dd = mysqli_fetch_assoc($sql)) { ?>
            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
              ...
              <div class="ms-auto text-end">
                <a class="btn btn-link text-success text-gradient px-3 mb-0" href="crash_dt.php?id=<?= $dd['id']; ?>"><i class="far fa-edit me-2"></i>Lihat Detail</a>
              </div>
            </li>
          <?php } ?>
        </ul>
